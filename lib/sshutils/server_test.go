...
func TestStartStop(t *testing.T) {
	...
	fn := NewChanHandlerFunc(func(_ context.Context, _ *ConnectionContext, nch ssh.NewChannel) {
		...
		if err := nch.Reject(ssh.Prohibited, "nothing to see here"); err != nil {
			logrus.Errorf("Failed to reject connection: %v", err)
		}
	})
...
func TestConfigureCiphers(t *testing.T) {
	...
	require.NotNilf(t, err, "cipher mismatch, should fail, got nil")
