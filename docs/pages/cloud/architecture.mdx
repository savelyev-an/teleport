...
upgrade. For example, the team will deploy (=teleport.major.version=).1.0
instead of (=teleport.major.version=).0.0. The first minor release happens 3-4
...
are running within 3 months of the upgrade. Failure to upgrade agents to the
