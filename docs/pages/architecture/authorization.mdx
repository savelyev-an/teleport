...
[`tctl users add`](../setup/reference/cli.mdx) or API call.
...
<Notice type="tip">
You can use `where` fields in all resource rules. Check out [the full role reference](../access-controls/reference.mdx) contains full role spec for details.
</Notice>
...
- [Access Requests Guides](../access-controls/access-requests/index.mdx)
