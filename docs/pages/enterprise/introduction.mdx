...
| [Access Requests](../access-controls/access-requests/index.mdx) | User interface for teams to create and review requests to access infrastructure with escalated privileges. |
...
information](../access-controls/access-requests/index.mdx)
