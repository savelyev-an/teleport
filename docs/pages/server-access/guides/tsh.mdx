...
More detailed information about `join_sessions` policies can be found in the
[role reference](../../access-controls/role-spec.mdx) and
[moderated sessions guide](../../access-controls/guides/moderated-sessions.mdx).
